      ...
      <div className="space-y-3">
        ...
        {alertsEnabled && (
          <div className="ml-14 grid gap-3">
            <div>
              <label htmlFor="alerts-daily-cost" className="text-xs text-[#808080] mb-1 block">{t('settings.alerts.dailyCost')}</label>
              ...
              <input
                ...
                className="w-40 bg-[#2a2a2a] border border-[#333] rounded-md px-3 py-2 text-sm font-mono focus:outline-none focus:border-[#3b82f6]"
              />
            </div>
            <div>
              <label htmlFor="alerts-daily-tokens" className="text-xs text-[#808080] mb-1 block">{t('settings.alerts.dailyTokens')}</label>
            ...
            <div>
              <label htmlFor="alerts-session-window" className="text-xs text-[#808080] mb-1 block">{t('settings.alerts.sessionWindow')}</label>
